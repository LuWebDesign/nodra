...
- Preserve schema version 9 migration/defaulting and validation, including stable addresses for rectangle/circle/arc/ellipse/line anchors, sketch edge dimensions, stable path/glyph segment IDs, and path/spline nodes and handles.
