...
- Preserve schema version 8 migration/defaulting and validation, including stable addresses for rectangle/circle/ellipse/line anchors, sketch edge dimensions, stable path/glyph segment IDs, and path/spline nodes and handles.
