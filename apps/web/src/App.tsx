      ...
      return <g key={`spline-overlay-${spline.id}`} data-spline-overlay={spline.id}>
        ...
        {visible && spline.nodes.map((node, nodeIndex) => {
          ...
          return <g key={node.id}>
            ...
            {nodeIndex === 0 && splineCloseTarget && <rect data-spline-close-ring={spline.id} x={node.anchor.x - 6.5 / zoom} y={node.anchor.y - 6.5 / zoom} width={13 / zoom} height={13 / zoom} fill="none" stroke="#14b8a6" strokeWidth={1 / zoom} pointerEvents="none" />}
