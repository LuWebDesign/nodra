...
const mark = globalThis.document.createElementNS("http://www.w3.org/2000/svg", "rect");
  ...
  const commitTextDraft = () => {
    ...
    const text: TextElement = {
      ...
      position: draft.position, size: textSizeFor(draft.value, draft.fontSize ?? 12), text: draft.value,
      fontFamily: textFontFamily, fontSize: draft.fontSize ?? 12, fontWeight: "normal", fontStyle: "normal", textAlign: "left", lineHeight: 1.2, rotation: 0,
