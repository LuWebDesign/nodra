...
import { cornerRadiusPatch, cornerRadiusValue, geometryPatch, geometryValue, pagePropertyValue } from "./propertyBar.js";
...
describe("property bar helpers", () => {
  it("reads page width and height without introducing page position fields", () => {
    const page = { width: 1200, height: 900 };

    expect(pagePropertyValue(page, "width")).toBe(1200);
    expect(pagePropertyValue(page, "height")).toBe(900);
  });
