...
const outline: GlyphOutlineData = {
  ...
  contours: [
    { nodes: [{ id: "outer-a", anchor: { x: 10, y: 10 }, join: "corner" }, { id: "outer-b", anchor: { x: 20, y: 10 }, join: "corner" }, { id: "outer-c", anchor: { x: 20, y: 20 }, join: "corner" }], segments: [{ id: "fixture-segment-1", type: "cubicBezier", startNodeId: "outer-a", endNodeId: "outer-b", control1: { x: 13, y: 7 }, control2: { x: 17, y: 7 } }, { id: "fixture-segment-2", type: "line", startNodeId: "outer-b", endNodeId: "outer-c" }, { id: "fixture-segment-3", type: "line", startNodeId: "outer-c", endNodeId: "outer-a" }] },
    { nodes: [{ id: "hole-a", anchor: { x: 13, y: 13 }, join: "corner" }, { id: "hole-b", anchor: { x: 17, y: 13 }, join: "corner" }, { id: "hole-c", anchor: { x: 17, y: 17 }, join: "corner" }], segments: [{ id: "fixture-segment-4", type: "line", startNodeId: "hole-a", endNodeId: "hole-b" }, { id: "fixture-segment-5", type: "line", startNodeId: "hole-b", endNodeId: "hole-c" }, { id: "fixture-segment-6", type: "line", startNodeId: "hole-c", endNodeId: "hole-a" }] },
  ],
};
