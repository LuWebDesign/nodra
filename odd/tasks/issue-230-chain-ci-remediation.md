...
- [ ] **R1 — Make role-foundation slice independently CI-green**
  ...
  - Independent GPT-6 Luna verification passed root lint, typecheck, unit tests (736/736), E2E (73 passed, 1 skipped), build and `git diff --check`; focused writer tests passed (41/41). Build chunk-size warning was non-blocking. Commit identity pending.
